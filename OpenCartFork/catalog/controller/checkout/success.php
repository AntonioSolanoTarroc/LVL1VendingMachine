...
class ControllerCheckoutSuccess extends Controller { 
	public function index() { 	
		...
		if ( isset($this->session->data['order_id']) && ( ! empty($this->session->data['order_id']))  ) {
			...
			$this->session->data['last_order_invoice'] = $this->session->data['invoice_no'];
		}
		...
		$this->data['text_invoice'] = sprintf($this->language->get('text_invoice'),
			$this->session->data['last_order_invoice']);
