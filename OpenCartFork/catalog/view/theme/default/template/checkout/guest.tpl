...
<div style="display: none;">
  ...
  <input type="text" name="address_1" value="814 E. Broadway" class="large-field" />
  <br />
  <br />
  ...
  <input type="text" name="city" value="Louisville" class="large-field" />
  <br />
  <br />
  <span id="payment-postcode-required" class="required">*</span> <?php echo $entry_postcode; ?><br />
  <input type="text" name="postcode" value="40205" class="large-field" />
  <br />
  <br />
  ...
  <input type="text" name="zone_id" value="3639" class="large-field" />
